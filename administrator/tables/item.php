...
/**
  * Summer_reader Item Table class
  ...
  */
  ...
  parent :: __construct('#__summer_reader', 'id', $db);
  }
 /**
 ...
 /** check for existing name */
  $query = 'SELECT id FROM #__summer_reader WHERE title = ' . $this->_db->Quote($this->title) . ' AND catid = ' . (int) $this->catid;
